...
public class SettingsFragment extends PreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        mThemeManager.onCreate(getActivity());
        super.onCreate(savedInstanceState);

        //bindService(new Intent(getActivity(), SqueezeService.class), serviceConnection,
    ...
    public void onResume() {
        super.onResume();
        mThemeManager.onResume(getActivity());
    }
    ...
    public static void show(Context context) {
        final Intent intent = new Intent(context, SettingsFragment.class);
